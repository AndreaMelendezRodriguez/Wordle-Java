...
public class Wordle {
	...
	public static void main(String[] args) {
		...
		System.out.println("");
		System.out.println(cyan + " ##   ##        #####        ######        #####         ####          #######" + reseteado);
		System.out.println(cyan + " ##   ##       ##   ##        ##  ##        ## ##         ##            ##   #" + reseteado);
		System.out.println(cyan + " ##   ##       ##   ##        ##  ##        ##  ##        ##            ## " + reseteado);
		System.out.println(cyan + " ## # ##       ##   ##        #####         ##  ##        ##            ####" + reseteado);
		System.out.println(cyan + " #######       ##   ##        ## ##         ##  ##        ##   #        ## " + reseteado);
		...
		System.out.println(amarillo + " Tienes 6 intentos para adivinar la palabra de 5 letras del día, ¡suerte!" + reseteado);
		System.out.println("");
		System.out.println(amarillo + " -------------------------------------------------------------------------------------" + reseteado);
		System.out.println("");
		...
		if (intento.equals(correcta)) {
			System.out.println(amarillo + " --------------------------------------------------------------------------------------------------" + reseteado);
			System.out.println("");
			System.out.println(verde + " ##  ##   ##    ##      #####              ####     ##     ##   ##    ##     #####     #####   ##" + reseteado);
			System.out.println(verde + " ##  ##   ##   ####    ##   ##            ##  ##   ####    ###  ##   ####     ## ##   ##   ##    " + reseteado);
			System.out.println(verde + " ##  ##   ##  ##  ##   #                 ##       ##  ##   #### ##  ##  ##    ##  ##  ##   ##  ##" + reseteado);
			System.out.println(verde + " ##  #######  ##  ##    #####            ##       ##  ##   ## ####  ##  ##    ##  ##  ##   ##  ##" + reseteado);
			System.out.println(verde + " ##  ##   ##  ######        ##           ##  ###  ######   ##  ###  ######    ##  ##  ##   ##  ##" + reseteado);
		...
		if (!intento.equals(correcta)) {
			System.out.println(amarillo + " --------------------------------------------------------------------------------------------------------------------" + reseteado);
			System.out.println("");
			System.out.println(amarillo + " ¡No te quedan más intentos! La palabra correcta era " + correcta + reseteado);
			System.out.println("");
			System.out.println("");
			System.out.println(amarillo + " ##   ##    ##      #####            ######   #######  ######   #####     ####    #####     #####               ## " + reseteado);
			System.out.println(amarillo + " ##   ##   ####    ##   ##            ##  ##   ##   #   ##  ##   ## ##     ##      ## ##   ##   ##             ## " + reseteado);
